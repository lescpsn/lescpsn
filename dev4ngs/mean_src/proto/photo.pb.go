...
func (PhotoType) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (PhotoPrivacy) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (PersistentType) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*BasePhoto) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*Photo) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*Note) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*File) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func init() { proto1.RegisterFile("photo.proto", fileDescriptor7) }
