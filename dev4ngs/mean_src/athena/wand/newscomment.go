...
//)
//
//func (m *AthenaController) NewsNewsComment(cu *User, tUUID, rcUUID string, content string, timestamp time.Time) (Dungeons, error) {
//
...
//}
//
//func (m *AthenaController) NewsDeleteComment(cu *User, tUUID, cUUID string) (Dungeons, error) {
//
//	gNRsp, err := Cl.GetNewsByUUID(context.TODO(), &GetByUUIDRequest{
//		UUID: tUUID,
//	})
...
//}
//
//func (m *AthenaController) FindNewsComments(cu *User, tUUID uuid.UUID, options *QueryParameter) (Dungeons, error) {
//
//	gNRsp, err := Cl.GetNewsByUUID(context.TODO(), &GetByUUIDRequest{
//		UUID: tUUID.String(),
//	})
