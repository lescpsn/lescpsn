...
func DiaryToData(dry *proto.Diary, isList bool) (Dungeons, error) {
...
func Str2DiaryPrivacy(str string) (proto.DiaryPrivacy, error) {

	switch str {

	case "1":

		return proto.DiaryPrivacy_diary_privacy_public, nil

	case "2":
		return proto.DiaryPrivacy_diary_privacy_private, nil
